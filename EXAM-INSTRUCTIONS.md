...
For the solution, we request that you use either Golang, Scala, Javascript/NodeJS, Java, Ruby, or C#.  You may not use any external libraries to solve this problem, but you may use external libraries or tools for building or testing purposes (i.e. Maven, Gradle, godeps, npm, etc). Specifically, you may use unit testing libraries or build tools available for your chosen language (e.g., JUnit, Ant, NUnit, Rspec, Rake, etc.) and you can use logging libraries for ease of printing output, if you desire. For security reasons, please do not submit your C# code as a .msi file.
